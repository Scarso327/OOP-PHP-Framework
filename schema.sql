...
-- Dumping data for table forumboard.permissions: ~1 rows (approximately)
...
-- Dumping data for table forumboard.themes: ~1 rows (approximately)
...
-- Dumping data for table forumboard.themes_css: ~7 rows (approximately)
...
-- Dumping data for table forumboard.themes_views: ~8 rows (approximately)
